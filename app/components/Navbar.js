...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" lg:px-8 lg:py-4 bg-red-700 sticky top-0 z-50">
        <div className="flex justify-center gap-20 font-bold">
          <div className="bg-white scale-50 lg:scale-[1.5] lg:translate-y-5 border-2 px-10 pb-4 border-kuning rounded-lg">
            <Link href="/">
              <img
                className="w-20"
                src="https://raw.githubusercontent.com/Syafar44/assets/main/assets/image/Panglima.png"
              />
            </Link>
          </div>
        </div>
